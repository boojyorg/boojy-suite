...
>
> Part of a three-doc set at the suite root: *Boojy Suite — Vision (2026 Refresh)* = **why**
...
- **In the suite root:** the Vision doc, brand docs, the shared **`CLAUDE.md`**, and this file.
  Retired docs → `archive/`. (Operational status lives in the vault — see the header.)
