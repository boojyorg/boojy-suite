...
|------|------------|----------------------------|--------|
| **[boojy-notes](https://github.com/boojyorg/boojy-notes)** | Markdown note-taking — your files on disk, wikilinks (React + Electron) | Notion, Obsidian | **Alpha — v0.8.0** (early access, 2026-09-17). Current focus: the desktop Beta. |
...
| **[boojy-design](https://github.com/boojyorg/boojy-design)** | Web image editor — paint, shapes, text, layers | Photoshop, Procreate, Canva | **Preview — v0.4.0.** Works; development currently paused. Not promoted on boojy.org since 2026-09-11 — `/design/` stays live and linkable, just unlisted. |
...
| **Repo scaffold** (what a standard Boojy repo contains + how to set up its gate) | [`docs/REPO_TEMPLATE.md`](docs/REPO_TEMPLATE.md) |
